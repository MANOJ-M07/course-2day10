<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductRegistration.aspx.cs" Inherits="ProductReg.ProductRegistration" %>
...
<body>
    <form id="form1" runat="server">
        <div class="con">
            ...
            <div class="row" >
                 <div class ="col-md-1"><asp:Image runat="server" ID="Image3" ImageUrl="~/Image/clothing.jpg"
                       width="253px" Height="203px" CssClass ="mw-100" /></div>
            </div>
        </div>
        <table class="w-100">
            <tr>
