...
<body>
    <form id="form1" runat="server">
        <div class="container">
            ...
            <div class="row">
                   <div class ="col-md-4"><asp:Image runat="server" ID="Image3" ImageUrl="~/Image/clothing.jpg"
                       width="150" Height="150" CssClass ="img-fluid" /></div>
                   <div class ="col-md-4"><asp:Image runat="server" ID="Image1" ImageUrl="~/Image/electronics.jpg"
                       width="150" Height="150" CssClass ="img-fluid" /></div>
                   <div class ="col-md-4"><asp:Image runat="server" ID="Image2" ImageUrl="~/Images/ps3.jpg"
                       width="150" Height="150" CssClass ="img-fluid" /></div>
                </div>
        </div>
    </form>
